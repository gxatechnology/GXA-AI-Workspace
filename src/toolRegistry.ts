...
export const toolRegistry: ToolDefinition[] = [
  ...
  { id: 'humanizer', name: 'AI Humanizer', route: 'ai-humanizer', icon: 'sparkles', category: 'Originality and Writing Quality', description: 'Make mechanical writing sound more natural.', guestAccess: true, planAccess: 'Starter', status: 'available', keywords: ['natural', 'tone', 'humanize'], primary: false, more: true },
  ...
  { id: 'pdf', name: 'PDF Intelligence', route: 'pdf-intelligence', icon: 'file', category: 'PDF and Document Intelligence', description: 'Read, analyze and work with PDF documents.', guestAccess: true, planAccess: 'Starter', status: 'available', keywords: ['pdf', 'document', 'chat', 'extract'], primary: true, more: true },
  { id: 'ocr', name: 'Media OCR', route: 'ocr', icon: 'scan', category: 'Media, Vision and Creative', description: 'Extract and review text from real images with clear uncertainty.', guestAccess: true, planAccess: 'Free', status: 'available', keywords: ['scan', 'image', 'text extraction', 'handwriting', 'table'], primary: false, more: true },
  ...
  { id: 'images', name: 'Media Studio', route: 'images', icon: 'image', category: 'Media, Vision and Creative', description: 'Create, edit, understand and organize original visual assets.', guestAccess: true, planAccess: 'Free', status: 'available', keywords: ['image', 'visual', 'asset', 'creative', 'logo', 'marketing', 'ocr'], primary: false, more: true, isNew: true },
  ...
  { id: 'collaboration', name: 'Team Space', route: 'collaboration', icon: 'users', category: 'Team and Enterprise', description: 'Collaborate across workspace seats.', guestAccess: false, planAccess: 'Pro', status: 'available', keywords: ['team', 'collaborate', 'enterprise'], primary: false, more: true },
  { id: 'platform', name: 'Workspace & Organization', route: 'platform', icon: 'building', category: 'Team and Enterprise', description: 'Manage workspaces, organizations, teams, access, usage, API and automation.', guestAccess: false, planAccess: 'Account', status: 'available', keywords: ['workspace', 'organization', 'team', 'api', 'webhook', 'automation', 'security'], primary: false, more: true, isNew: true },
