...
export default function AllTools({ onSelectWorkspace, onOpenUpgradeModal }: AllToolsProps) {
  ...
  const tools: ToolItem[] = [
    ...
    { id: 'resume-builder', name: 'Resume Builder', desc: 'Build professional, ATS-friendly resume layouts.', category: 'Writing', isPro: true, workspaceId: 'ai-writing', icon: Bookmark },
